...
const Header= ()=>{
    ...
    console.log("(Header.js) Current User:", myContext.currUser);
            ...
            <nav className='header-contents'>
                <Link to={'/'}><img className='logo' src={logo} alt="logo" /></Link>
                {
                    ...
                    <Link to={'/dashboard'} className='user-profile'>
                        ...
                        {/* <p className='user-name'>{myContext.currUser.fullName.split(' ')[0]}</p> */}
                        <p className='user-name'>{myContext.currUser?.fullName ? toTitleCase(myContext.currUser.fullName.split(' ')[0]) : 'Guest'}</p>
                    </Link>
                    :
